...
const About = () => {
    ...
    const text = [
      <>
        Welcome to our dynamic typing platform! Hi, I'm Utsav Shah, a passionate web developer, and creator of this amazing website. You can find more about myself through my portfolio:
        <Link to="https://utsavshah.vercel.app" target="_blank" className='link-portfolio'>Utsav Shah</Link>.
      </>,
